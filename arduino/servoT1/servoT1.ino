...
// Igual aquí esta calibrado para no romper los servos
...
void servoAngle (int _servoNum, int _angle) {
...
void loop() {
  ...
  // esta funcion esta bien, van de 600 hasta 2300
  //pwm.writeMicroseconds(15, 2200);
